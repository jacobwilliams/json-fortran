...
#include "json_macros.inc"
    ...
    procedure,private :: json_value_add_string_vec_val_ascii
        ...
        generic,public :: get => &
            ...
            json_get_alloc_string_vec,MAYBEWRAP(json_get_alloc_string_vec_with_path),&
        ...
        procedure,private :: MAYBEWRAP(json_get_alloc_string_vec_with_path)
...
!
!  This is an alternate version of [[json_get_string_vec_with_path]].
...
!      a user-defined string type.
    ...
    subroutine json_get_alloc_string_vec_with_path(json, me, path, vec, ilen, found)
    ...
    end subroutine json_get_alloc_string_vec_with_path
!*****************************************************************************************

!*****************************************************************************************
!>
!  Alternate version of [[json_get_alloc_string_vec_with_path]], where "path" is kind=CDK

    subroutine wrap_json_get_alloc_string_vec_with_path(json,me,path,vec,ilen,found)
    ...
    end subroutine wrap_json_get_alloc_string_vec_with_path
!*****************************************************************************************
